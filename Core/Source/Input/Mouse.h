...
struct MouseScrollEvent
{
    ...
    explicit MouseScrollEvent(float wheelDelta)
...
struct MouseButtonDownEvent
{
    ...
    explicit MouseButtonDownEvent(MouseCode mouseCode)
        : Code(mouseCode)
    {}
};
...
struct MouseButtonUpEvent
{
    ...
    explicit MouseButtonUpEvent(MouseCode mouseCode)
        : Code(mouseCode)
    {}
};
